...
#ifdef CIDR4_FILTER
struct bpf_elf_map __section_maps xdp_pfx_fix_v4 = {
	.type		= BPF_MAP_TYPE_HASH,
	.size_key	= sizeof(struct lpm_v4_key),
	.size_value	= sizeof(struct lpm_val),
	.flags		= 0,
	.pinning	= PIN_GLOBAL_NS,
	.max_elem	= 1024 * 1024 * 20,
};

#ifdef CIDR4_LPM_PREFILTER
struct bpf_elf_map __section_maps xdp_pfx_dyn_v4 = {
...
#ifdef CIDR6_FILTER
struct bpf_elf_map __section_maps xdp_pfx_fix_v6 = {
	.type		= BPF_MAP_TYPE_HASH,
...
struct bpf_elf_map __section_maps xdp_pfx_dyn_v6 = {
	.type		= BPF_MAP_TYPE_LPM_TRIE,
	.size_key	= sizeof(struct lpm_v6_key),
	.size_value	= sizeof(struct lpm_val),
	.flags		= BPF_F_NO_PREALLOC,
...
#ifdef CIDR4_LPM_PREFILTER
	if (map_lookup_elem(&xdp_pfx_dyn_v4, &pfx))
		return XDP_DROP;
	else
#endif /* CIDR4_LPM_PREFILTER */
		return map_lookup_elem(&xdp_pfx_fix_v4, &pfx) ?
...
#ifdef CIDR6_LPM_PREFILTER
	if (map_lookup_elem(&xdp_pfx_dyn_v6, &pfx))
		return XDP_DROP;
	else
#endif /* CIDR6_LPM_PREFILTER */
		return map_lookup_elem(&xdp_pfx_fix_v6, &pfx) ?
